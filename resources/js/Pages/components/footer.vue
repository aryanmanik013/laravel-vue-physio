<template>
  ...
  >
    ...
    <!--begin::Menu-->
    <ul
      class="menu menu-white menu-hover-primary fw-semibold order-1 opacity-75"
    >
      <li class="menu-item">
                ...
                <div class="overflow-auto pb-5">
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="symbol symbol-circle symbol-25px">
                        <img
                          src="assets-dashboard/media/avatars/300-20.jpg"
                          alt="img"
                        />
                      </div>
                      <!--end::User-->
              ...
              <div class="timeline-content mb-10 mt-n2">
                ...
                <div class="overflow-auto pe-3">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    >
                      <img
                        src="assets-dashboard/media/avatars/300-1.jpg"
                        alt="img"
                      />
                    </div>
                    <!--end::User-->
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="mb-5 pe-3">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    >
                      <img
                        src="assets-dashboard/media/avatars/300-23.jpg"
                        alt="img"
                      />
                    </div>
                    <!--end::User-->
                  ...
                  >
                    ...
                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                      ...
                      <img
                        alt=""
                        class="w-30px me-3"
                        src="assets-dashboard/media/svg/files/pdf.svg"
                      />
                      <!--end::Icon-->
                      <!--begin::Info-->
                    ...
                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                      <!--begin::Icon-->
                      <img
                        alt="../../demo19/dist/apps/projects/project.html"
                        class="w-30px me-3"
                        src="assets-dashboard/media/svg/files/doc.svg"
                      />
                      <!--end::Icon-->
                      <!--begin::Info-->
                      <div class="ms-1 fw-semibold">
                    ...
                    <div class="d-flex flex-aligns-center">
                      ...
                      <img
                        alt="../../demo19/dist/apps/projects/project.html"
                        class="w-30px me-3"
                        src="assets-dashboard/media/svg/files/css.svg"
                      />
                      <!--end::Icon-->
                      <!--begin::Info-->
                      <div class="ms-1 fw-semibold">
                    ...
                    <div class="overlay me-10">
                      ...
                      <div class="overlay-wrapper">
                        <img
                          ...
                          src="assets-dashboard/media/stock/600x400/img-29.jpg"
                        />
                      </div>
                      <!--end::Image-->
                      <!--begin::Link-->
                    ...
                    <div class="overlay me-10">
                      ...
                      <div class="overlay-wrapper">
                        <img
                          alt="img"
                          class="rounded w-150px"
                          src="assets-dashboard/media/stock/600x400/img-31.jpg"
                        />
                      </div>
                      <!--end::Image-->
                      <!--begin::Link-->
                    ...
                    <div class="overlay">
                      ...
                      <div class="overlay-wrapper">
                        <img
                          alt="img"
                          class="rounded w-150px"
                          src="assets-dashboard/media/stock/600x400/img-40.jpg"
                        />
                      </div>
                      <!--end::Image-->
                      <!--begin::Link-->
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    >
                      <img
                        src="assets-dashboard/media/avatars/300-4.jpg"
                        alt="img"
                      />
                    </div>
                    <!--end::User-->
            ...
            <div class="d-flex flex-column align-items-start">
              ...
              <div class="d-flex align-items-center mb-2">
                ...
                <div class="symbol symbol-35px symbol-circle">
                  <img
                    alt="Pic"
                    src="assets-dashboard/media/avatars/300-25.jpg"
                  />
                </div>
                <!--end::Avatar-->
                <!--begin::Details-->
              ...
              <div class="row g-5">
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo1.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo2.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo3.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo4.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo5.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo6.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo7.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo8.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo9.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo10.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo11.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo12.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo13.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo14.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo15.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo16.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo17.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo18.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo19.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo20.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo21.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo22.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo23.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                ...
                <div class="col-6">
                  ...
                  >
                    <div class="overlay-wrapper">
                      <img
                        src="assets-dashboard/media/demos/demo24.png"
                        alt="demo"
                        class="w-100"
                      />
                    </div>
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <a
                        href="https://preview.keenthemes.com/metronic8/demo24"
                        class="btn btn-sm btn-success shadow"
                        >Demo 24</a
                      >
                    </div>
  ...
  >
    ...
    <button
      ...
      class="
        engage-demos-toggle engage-btn
        btn
        shadow-sm
        fs-6
        px-4
                  ...
                  <div class="w-100">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                      ...
                      <div class="position-relative">
                        ...
                        >
                          <img
                            src="assets-dashboard/media/svg/card-logos/visa.svg"
                            alt=""
                            class="h-25px"
                          />
                          <img
                            src="assets-dashboard/media/svg/card-logos/mastercard.svg"
                            alt=""
                            class="h-25px"
                          />
                          <img
                            src="assets-dashboard/media/svg/card-logos/american-express.svg"
                            alt=""
                            class="h-25px"
                          />
                        </div>
                ...
                <div data-kt-stepper-element="content">
                  <div class="w-100 text-center">
                    ...
                    <div class="text-center px-4 py-15">
                      <img
                        src="assets-dashboard/media/illustrations/sketchy-1/9.png"
                        alt=""
                ...
                <div class="mh-375px scroll-y me-n7 pe-7">
                  ...
                  >
                    ...
                    <div class="symbol symbol-35px symbol-circle me-5">
                      <img
                        alt="Pic"
                        src="assets-dashboard/media/avatars/300-5.jpg"
                      />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Info-->
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="symbol symbol-35px symbol-circle">
                        <img
                          alt="Pic"
                          src="assets-dashboard/media/avatars/300-12.jpg"
                        />
                      </div>
                      <!--end::Avatar-->
                      <!--begin::Details-->
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="symbol symbol-35px symbol-circle">
                        <img
                          alt="Pic"
                          src="assets-dashboard/media/avatars/300-13.jpg"
                        />
                      </div>
                      <!--end::Avatar-->
                      <!--begin::Details-->
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="symbol symbol-35px symbol-circle">
                        <img
                          alt="Pic"
                          src="assets-dashboard/media/avatars/300-21.jpg"
                        />
                      </div>
                      <!--end::Avatar-->
                      <!--begin::Details-->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
          ...
          <div class="btn btn-light-primary fw-bold w-100 mb-8">
            <img
              alt="Logo"
              src="assets-dashboard/media/svg/brand-logos/google-icon.svg"
              class="h-20px me-3"
